...
[`Home`](../jsopx.RCLxComponents/p1/v1/README.md) » [`Introduction`](../jsopx.Global/Introduction/) » [`Projects`](../jsopx.RCLxComponents/p1/v1/OpenProjects/) · · [`Use Latest`](../jsopx.RCLxComponents/README.md) · [`By-Phase`](../jsopx.RCLxComponents/p1/v1/README.md) · **`From Scratch`** · · [`« Previous`](../jsopx.RCLxProper/p1/v1/RECREATEME.md) [`Next »`](../jsopx.AspNetCore/p1/v1/RECREATEME.md)
...
- [Visual Studio (v 17.14.21)](../jsopx.RCLxComponents/p1/v1/Technologies/VisualStudio.md)
- [.NET Framework (v 9.2.1)](../jsopx.RCLxComponents/p1/v1/Technologies/NetFrameworkSdk.md)
- [ASP.NET Core (v 9.2.1)](../jsopx.RCLxComponents/p1/v1/Technologies/AspNetCore.md)
...
- **[Install Using Latest](../jsopx.RCLxComponents/README.md)** → **Install** or **explore** the latest version of **this project**, using the `JSopX.RCLxComponents` _Using Latest_ Variant.  
...
1. **[Continue](../jsopx.AspNetCore/p1/v1/RECREATEME.md)** → **Continue** as **you were**, **creating projects** from scratch, step-by-step. You'll move onto the next project, using the `JSopX.AspNetCore` _From Scratch_ Variant.   

---

1. **[Install Using Latest](../jsopx.RCLxComponents/README.md)** → **Install** or **explore** the latest version of **this project**, using the `JSopX.RCLxComponents` _Using Latest_ Variant.  
2. **[Browse By-Phase](../jsopx.RCLxComponents/p1/v1/README.md)** → **Browse** **previous versions** of the application by **phases** using the `JSopX.RCLxComponents` _By-Phase_ Variant.   
...
[`Home`](../jsopx.RCLxComponents/p1/v1/README.md) » [`Introduction`](../jsopx.Global/Introduction/) » [`Projects`](../jsopx.RCLxComponents/p1/v1/OpenProjects/) · · [`Use Latest`](../jsopx.RCLxComponents/README.md) · [`By-Phase`](../jsopx.RCLxComponents/p1/v1/README.md) · **`From Scratch`** · · [`⇧ Back to Top`](#table-of-contents) · [`« Previous`](../jsopx.RCLxProper/p1/v1/RECREATEME.md) [`Next »`](../jsopx.AspNetCore/p1/v1/RECREATEME.md)
