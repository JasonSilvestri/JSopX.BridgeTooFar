...
[`Home`](../jsopx.SharedResources/README.md) » [`Introduction`](../jsopx.Global/Introduction/) » [`Projects`](../../OpenProjects/) · · **`Use Latest`** · [`By-Phase`](../jsopx.SharedResources/p1/v1/README.md) · [`From Scratch`](../jsopx.SharedResources/p1/v1/RECREATEME.md) · · [`« Previous`](../jsopx.BridgeTooFar/) [`Next »`](../jsopx.RCLxAssets/)
...
- **[Browse By-Phase](../jsopx.SharedResources/p1/v1/README.md)** → **Browse** **previous versions** of the application by **phases** using the `JSopX.SharedResources` _By-Phase_ Variant.   
- **[Start From Scratch](../jsopx.SharedResources/p1/v1/RECREATEME.md)** → **Create project** from scratch, step-by-step, using the `JSopX.SharedResources` _From Scratch_ Variant.
...
The **`JSopX.Shared Resources` Project** is not widely used as a resource, because it was always intended to show how traditional class libraries can still be used with newer technologies in projects, like the [`JSopX.AngularCore`](../jsopx.AngularCore), [`JSopX.BlazorServerCore`](../jsopx.BlazorServerCore), [`JSopX.ReactCore`](../jsopx.ReactCore), [`JSopX.VueCore`](../jsopx.VueCore), etc. 

In fact, newer Razor Class Libraries such as [`JSopX.RCLxAssets`](../jsopx.RCLxAssets) (_Development-Ready_) and [`JSopX.RCLxProper`](../jsopx.RCLxProper) (_Produciton-Ready_) are the successors of this project. It is because of this that you only see the following dependency:
...
1. **Reference the JSopX™ Shared Resources Project**:
   - Add a reference to `JSopX.SharedResources` in [`JSopX.BlazorServerCore`](../jsopx.BlazorServerCore/p1/v1).
...
1. **[Continue](../jsopx.RCLxAssets/README.md)** → _Continue_ as **you were**, exploring and/or installing other projects like you did with **this project**. You'll move onto the next project, using the `JSopX.RCLxAssets` _Using Latest_ Variant.  

---

1. **[Browse By-Phase](../jsopx.SharedResources/p1/v1/README.md)** → **Browse** **previous versions** of the application by **phases** using the `JSopX.SharedResources` _By-Phase_ Variant.   
2. **[Start From Scratch](../jsopx.SharedResources/p1/v1/RECREATEME.md)** → **Create project** from scratch, step-by-step, using the `JSopX.SharedResources` _From Scratch_ Variant.
...
[`Home`](../jsopx.SharedResources/README.md) » [`Introduction`](../jsopx.Global/Introduction/) » [`Projects`](../../OpenProjects/) · · **`Use Latest`** · [`By-Phase`](../jsopx.SharedResources/p1/v1/README.md) · [`From Scratch`](../jsopx.SharedResources/p1/v1/RECREATEME.md) · · [`⇧ Back to Top`](#table-of-contents) · [`« Previous`](../jsopx.BridgeTooFar/) [`Next »`](../jsopx.RCLxAssets/)
