...
[`Home`](../jsopx.WebAPI/p1/v1/README.md) » [`Introduction`](../jsopx.Global/Introduction/) » [`Projects`](../jsopx.WebAPI/p1/v1/OpenProjects/) · · [`Use Latest`](../jsopx.WebAPI/README.md) · [`By-Phase`](../jsopx.WebAPI/p1/v1/README.md) · **`From Scratch`** · · [`« Previous`](../jsopx.ClassLibrary/p1/v1/RECREATEME.md) [`Next »`](../jsopx.BridgeTooFar/p1/v1/RECREATEME.md)
...
We initially create the project to simulate a [Shared Data, Service & Function Project](../jsopx.Global/Introduction/JSopxProjectsFamilies.md#3-shared-data-service--function-projects) that will need to be leveraged by the other new and existing client side and server side projects, which act as standards that conform to the initial [business requirements](../jsopx.Global/Introduction/JSopxEnterpriseBusinessRequirements.md) set forth by the fictional stakeholders.
...
- [Visual Studio (v 17.14.21)](../jsopx.AngularCore/p1/v1/Technologies/VisualStudio.md)
- [.NET Framework (v 9.2.1)](../jsopx.AngularCore/p1/v1/Technologies/NetFrameworkSdk.md)
- [ASP.NET Core (v 9.2.1)](../jsopx.AngularCore/p1/v1/Technologies/AspNetCore.md)
...
- **[Install Using Latest](../jsopx.WebAPI/README.md)** → **Install** or **explore** the latest version of **this project**, using the `JSopX.WebAPI` _Using Latest_ Variant.  
- **[Browse By-Phase](../jsopx.WebAPI/p1/v1/README.md)** → **Browse** **previous versions** of the application by **phases** using the `JSopX.WebAPI` _By-Phase_ Variant.   
...
1. **[Continue](../jsopx.BridgeTooFar/p1/v1/RECREATEME.md)** → **Continue** as **you were**, **creating projects** from scratch, step-by-step. You'll move onto the next project, using the `JSopX.BridgeTooFar` _From Scratch_ Variant.   

---

1. **[Install Using Latest](../jsopx.WebAPI/README.md)** → **Install** or **explore** the latest version of **this project**, using the `JSopX.WebAPI` _Using Latest_ Variant.  
2. **[Browse By-Phase](../jsopx.WebAPI/p1/v1/README.md)** → **Browse** **previous versions** of the application by **phases** using the `JSopX.WebAPI` _By-Phase_ Variant.   
...
[`Home`](../jsopx.WebAPI/p1/v1/README.md) » [`Introduction`](../jsopx.Global/Introduction/) » [`Projects`](../jsopx.WebAPI/p1/v1/OpenProjects/) · · [`Use Latest`](../jsopx.WebAPI/README.md) · [`By-Phase`](../jsopx.WebAPI/p1/v1/README.md) · **`From Scratch`** · · [`⇧ Back to Top`](#table-of-contents) · [`« Previous`](../jsopx.ClassLibrary/p1/v1/RECREATEME.md) [`Next »`](../jsopx.BridgeTooFar/p1/v1/RECREATEME.md)
