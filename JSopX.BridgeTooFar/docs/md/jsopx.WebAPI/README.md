...
[`Home`](../jsopx.WebAPI/README.md) » [`Introduction`](../jsopx.Global/Introduction/) » [`Projects`](../../OpenProjects/) · · **`Use Latest`** · [`By-Phase`](../jsopx.WebAPI/p1/v1/README.md) · [`From Scratch`](../jsopx.WebAPI/p1/v1/RECREATEME.md) · · [`« Previous`](../jsopx.ClassLibrary/) [`Next »`](../jsopx.BridgeTooFar/)
...
- **[Start From Scratch](../jsopx.WebAPI/p1/v1/RECREATEME.md)** → **Create project** from scratch, step-by-step, using the `JSopX.WebAPI` _From Scratch_ Variant.
...
1. **Reference the JSopX™ Web API Project**:
   - Add a reference to `JSopX.WebAPI` in [`JSopX.BlazorServerCore`](../jsopx.BlazorServerCore/p1/v1).
...
1. **[Continue](../jsopx.BridgeTooFar/README.md)** → _Continue_ as **you were**, exploring and/or installing other projects like you did with **this project**. You'll move onto the next project, using the `JSopX.BridgeTooFar` _Using Latest_ Variant.  

---

1. **[Browse By-Phase](../jsopx.WebAPI/p1/v1/README.md)** → **Browse** **previous versions** of the application by **phases** using the `JSopX.WebAPI` _By-Phase_ Variant.   
2. **[Start From Scratch](../jsopx.WebAPI/p1/v1/RECREATEME.md)** → **Create project** from scratch, step-by-step, using the `JSopX.WebAPI` _From Scratch_ Variant.
...
[`Home`](../jsopx.WebAPI/README.md) » [`Introduction`](../jsopx.Global/Introduction/) » [`Projects`](../../OpenProjects/) · · **`Use Latest`** · [`By-Phase`](../jsopx.WebAPI/p1/v1/README.md) · [`From Scratch`](../jsopx.WebAPI/p1/v1/RECREATEME.md) · · [`⇧ Back to Top`](#table-of-contents) · [`« Previous`](../jsopx.ClassLibrary/) [`Next »`](../jsopx.BridgeTooFar/)
