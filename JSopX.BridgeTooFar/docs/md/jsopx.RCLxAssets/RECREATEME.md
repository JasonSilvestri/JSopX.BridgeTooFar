...
[`Home`](../jsopx.RCLxAssets/p1/v1/README.md) » [`Introduction`](../jsopx.Global/Introduction/) » [`Projects`](../jsopx.RCLxAssets/p1/v1/OpenProjects/) · · [`Use Latest`](../jsopx.RCLxAssets/README.md) · [`By-Phase`](../jsopx.RCLxAssets/p1/v1/README.md) · **`From Scratch`** · · [`« Previous`](../jsopx.SharedResources/p1/v1/RECREATEME.md) [`Next »`](../jsopx.RCLxProper/p1/v1/RECREATEME.md)
...
- **[Install Using Latest](../jsopx.RCLxAssets/README.md)** → **Install** or **explore** the latest version of **this project**, using the `JSopX.RCLxAssets` _Using Latest_ Variant.  
- **[Browse By-Phase](../jsopx.RCLxAssets/p1/v1/README.md)** → **Browse** **previous versions** of the application by **phases** using the `JSopX.RCLxAssets` _By-Phase_ Variant.   
...
1. **[Continue](../jsopx.RCLxProper/p1/v1/RECREATEME.md)** → **Continue** as **you were**, **creating projects** from scratch, step-by-step. You'll move onto the next project, using the `JSopX.RCLxProper` _From Scratch_ Variant.   

---

1. **[Install Using Latest](../jsopx.RCLxAssets/README.md)** → **Install** or **explore** the latest version of **this project**, using the `JSopX.RCLxAssets` _Using Latest_ Variant.  
2. **[Browse By-Phase](../jsopx.RCLxAssets/p1/v1/README.md)** → **Browse** **previous versions** of the application by **phases** using the `JSopX.RCLxAssets` _By-Phase_ Variant.   
...
[`Home`](../jsopx.RCLxAssets/p1/v1/README.md) » [`Introduction`](../jsopx.Global/Introduction/) » [`Projects`](../jsopx.RCLxAssets/p1/v1/OpenProjects/) · · [`Use Latest`](../jsopx.RCLxAssets/README.md) · [`By-Phase`](../jsopx.RCLxAssets/p1/v1/README.md) · **`From Scratch`** · · [`⇧ Back to Top`](#table-of-contents) · [`« Previous`](../jsopx.SharedResources/p1/v1/RECREATEME.md) [`Next »`](../jsopx.RCLxProper/p1/v1/RECREATEME.md)
