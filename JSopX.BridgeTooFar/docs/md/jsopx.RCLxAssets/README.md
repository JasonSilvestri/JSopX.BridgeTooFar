...
[`Home`](../jsopx.RCLxAssets/README.md) » [`Introduction`](../jsopx.Global/Introduction/) » [`Projects`](../../OpenProjects/) · · **`Use Latest`** · [`By-Phase`](../jsopx.RCLxAssets/p1/v1/README.md) · [`From Scratch`](../jsopx.RCLxAssets/p1/v1/RECREATEME.md) · · [`« Previous`](../jsopx.SharedResources/) [`Next »`](../jsopx.RCLxProper/)
...
- **[Start From Scratch](../jsopx.RCLxAssets/p1/v1/RECREATEME.md)** → **Create project** from scratch, step-by-step, using the `JSopX.RCLxAssets` _From Scratch_ Variant.
...
1. **Reference the JSopX™ RCL x Assets Project**:
   - Add a reference to `JSopX.RCLxAssets` in [`JSopX.BlazorServerCore`](../jsopx.BlazorServerCore/p1/v1).
...
1. **[Continue](../jsopx.RCLxProper/README.md)** → _Continue_ as **you were**, exploring and/or installing other projects like you did with **this project**. You'll move onto the next project, using the `JSopX.RCLxProper` _Using Latest_ Variant.  

---

1. **[Browse By-Phase](../jsopx.RCLxAssets/p1/v1/README.md)** → **Browse** **previous versions** of the application by **phases** using the `JSopX.RCLxAssets` _By-Phase_ Variant.   
2. **[Start From Scratch](../jsopx.RCLxAssets/p1/v1/RECREATEME.md)** → **Create project** from scratch, step-by-step, using the `JSopX.RCLxAssets` _From Scratch_ Variant.
...
[`Home`](../jsopx.RCLxAssets/README.md) » [`Introduction`](../jsopx.Global/Introduction/) » [`Projects`](../../OpenProjects/) · · **`Use Latest`** · [`By-Phase`](../jsopx.RCLxAssets/p1/v1/README.md) · [`From Scratch`](../jsopx.RCLxAssets/p1/v1/RECREATEME.md) · · [`⇧ Back to Top`](#table-of-contents) · [`« Previous`](../jsopx.SharedResources/) [`Next »`](../jsopx.RCLxProper/)
