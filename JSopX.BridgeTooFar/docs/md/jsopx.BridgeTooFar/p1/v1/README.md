...
All `JSopX™ projects` follow a consistent directory structure. The most common project and solution structure is the one used for the `JSopX.BridgeTooFar` Visual Studio Solution.
...
### `JSopX.BridgeTooFar` Root Solution Files:
...
### `JSopX.BridgeTooFar` Root Project Files
