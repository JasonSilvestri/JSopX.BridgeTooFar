# JSopX™ Enterprise-Level Solution — Common (v1)

The **Jason Silvestri Open Project EXperiences (JSopX™) JSopX™** Enterprise-Level Solution is a modular SaaS architecture designed to provide comprehensive health management services. We use the `Common` section to hold information used commonly across the entire JSopX™ eco system.

---

[`Home`] » [`JSopX.BridgeTooFar`] » **[`Common`]**
...
[`Home`] » [`JSopX.BridgeTooFar`] » **[`Common`]** ··· [`⇧ Back to Top`]
...
[JSopX.BridgeTooFar (v 1.0)]: /JSopX.BridgeTooFar/docs/md/jsopx.Global/Solutions/README.md#-jsopxangularcore "JSopX™ Vue Core SaaS Project"
