# JSopX™ Solution Project (v1) -  Lexicon

The **Jason Silvestri Open Project EXperiences (JSopX™) JSopX™** Enterprise-Level Solution is a modular SaaS architecture designed to provide comprehensive health management services. It consists of multiple interconnected projects, each serving a specific purpose within the overall JSopX™ eco system.

---

[`Home`] » [`JSopX.BridgeTooFar`] » [`Common`] » **[`Lexicon`]**
...
| Development Environments & Frameworks | [`.NET Framework`]                          |   Microsoft's original software framework (v 9.2.1).                                               |
| Development Environments & Frameworks | [`ASP.NET Core`]                            |   The open-source, cross-platform framework for building modern web apps and APIs (v 9.2.1).       |
| Development Environments & Frameworks | [`.NET Core Blazor`]                        |   A framework for building interactive client-side web UIs with .NET (v 9.2.1).                    |
| Development Environments & Frameworks | [`.NET Core Maui Hybrid`]                   |   A framework for building cross-platform native and hybrid desktop/mobile apps (v 9.2.1).         |
| Languages & Runtimes                  | [`Python`]                                      |   A programming language used for scripting and data analysis (v 3.12.3x+).                        |
| Languages & Runtimes                  | [`Node`]                                        |   The JavaScript runtime environment (v 20.14.0).                                                  |
| Languages & Runtimes                  | [`Bash`]                                        |   The default command-line interpreter for many Unix systems (v 5.x+).                             |
| Languages & Runtimes                  | [`PowerShell`]                                  |   The command-line shell and scripting language from Microsoft (v 7.x+).                           |
| Web Technologies                      | [`npm`]                                         |   The Node package manager (v 10.8.1).                                                             |
| Web Technologies                      | [`Bootstrap`]                                   |   The front-end toolkit for designing responsive web pages (v 5.3.8).                              |
| Web Technologies                      | [`Angular CLI`]                                 |   The command-line interface for developing Angular applications (v 18.0.3).                       |
| Web Technologies                      | [`React`]                                       |   The JavaScript library for building user interfaces (v 18.2.0).                                  |
| Web Technologies                      | [`Vue`]                                         |   The progressive framework for building user interfaces (v 3.4.21).                               |
| Web Technologies                      | [`Vite`]                                        |   The next-generation front-end build tool/development server (v 5.2.8).                           |

> The Lexicon is a living document and will be updated as new terms and definitions are added to the JSopX™ ecosystem. Please refer to this document for the most current terminology.
