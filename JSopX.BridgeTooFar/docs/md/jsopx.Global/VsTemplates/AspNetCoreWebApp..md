# JSopX™ Visual Studio Templates — ASP.NET Core Web App (v1)
...
Template is used as a starting point for creating a new solution without any predefined projects or files.
