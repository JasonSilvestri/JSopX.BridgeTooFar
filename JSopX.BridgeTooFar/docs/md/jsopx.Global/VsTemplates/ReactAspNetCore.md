# JSopX™ Visual Studio Templates — React and ASP.NET Core (v1)
...
Template is used for building dynamic, component-based UIs for client-side applications in React that interact with ASP.NET Core server-side secure backends.
