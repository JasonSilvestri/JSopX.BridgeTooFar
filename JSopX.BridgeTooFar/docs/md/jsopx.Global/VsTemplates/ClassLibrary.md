# JSopX™ Visual Studio Templates — Class Library (v1)
...
Template is used to create reusable components, services, and utilities that can be shared across multiple projects within the JSopX™ ecosystem.
