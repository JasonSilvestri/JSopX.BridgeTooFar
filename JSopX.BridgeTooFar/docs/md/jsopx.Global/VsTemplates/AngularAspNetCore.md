# JSopX™ Visual Studio Templates — Angular and ASP.NET Core (v1)
...
Template is used for building dynamic, component-based UIs for client-side applications in Angular that interact with ASP.NET Core server-side secure backends.

### **Tags**: 

`C#`, `ASP.NET Core`, `TypeScript`, `Angular CLI`
