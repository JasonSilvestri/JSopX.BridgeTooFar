# JSopX™ Visual Studio Templates — Asp.NET Core Web API (v1)

**Gene rated by the JSopX™ SaaS Document Management project, codenamed, `JSopX.BridgeTooFar`.**
...
Template is used to create reusable UI components, layouts, and views that can be shared across multiple projects.
...
[JSopX.Titrate (v 1)]: /JSopX.BridgeTooFar/docs/md/jsopx.Global/Solutions/README.md#-jsopxmauihybridnetcore "JSopX™ MAUI Hybrid .NET Core SaaS Project"
