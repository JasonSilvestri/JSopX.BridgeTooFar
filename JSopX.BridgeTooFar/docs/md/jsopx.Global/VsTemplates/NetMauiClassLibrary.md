# JSopX™ Visual Studio Templates — .NET MAUI Class Library (v1)
...
Template is used for Cross-platform MAUI Hybrid App and Web Class Library Project Resources (Windows, Android, iOS, macOS, and Web).
