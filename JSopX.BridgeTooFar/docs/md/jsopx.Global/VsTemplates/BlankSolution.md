# JSopX™ Visual Studio Templates — Blank Soluiton (v1)

**Generated by the JSopX™ SaaS Document Management project, codenamed, `JSopX.BridgeTooFar`.**

---

By exploring the [Overview](#overview), you’ll gain insights into the technologies that power JSopX™, and the Visual Studio `Blank Solution` project template.
