# JSopX™ Visual Studio Templates — .NET MAUI Blazor Hybrid and Web App (v1)
...
Template is used for Cross-platform MAUI Hybrid App and Web Multi App Project Library (Windows, Android, iOS, macOS, and Web).

### **Tags**: 

`C#`, `Android`, `Blazor`, `Blazor Hybrid`, `iOS`, `Mac Catalyst`, `macOS`, `MAUI`, `Mobile`, `Windows`, `Tizen`
