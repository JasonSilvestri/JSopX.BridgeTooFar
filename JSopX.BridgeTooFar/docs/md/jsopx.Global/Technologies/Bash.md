...
[`Home`] » [`JSopX.BridgeTooFar`] » [`Solutions`] ·· [`VS Templates`] ·· [`Technologies`] » **[`Bash`]** 
...
- [JSopX™ SaaS Project Dependencies](#bash-jsopx-project-dependencies)

---

## **Overview**  

All JSopX™ SaaS Projects _can use_ `Bash` v **`5.x+`** (_or higher_), for command-line operations, such as cloning JSopX™ project repositories, initializing JSopX™ projects, and managing their dependencies. 
...
[`Bash`]: /JSopX.BridgeTooFar/docs/md/JSopX.Global/Technologies/Bash.md "JSopX™ SaaS Project Bash Technology Requirements"

<!--Root Solution Previous -->
[`« Previous`]: /JSopX.BridgeTooFar/docs/md/JSopX.Global/Technologies/Powershell.md "JSopX™ SaaS Project Solution Powershell Techologies"
<!--Root Solution Next -->
[`Next »`]: /JSopX.BridgeTooFar/docs/md/JSopX.Global/Technologies/Bootstrap.md "JSopX™ SaaS Project Solution Bootstrap Techologies"
