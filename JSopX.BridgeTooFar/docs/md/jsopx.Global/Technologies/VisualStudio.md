...
[`Home`] » [`JSopX.BridgeTooFar`] » [`Solutions`] ·· [`VS Templates`] ·· [`Technologies`] » **[`Visual Studio`]** 
...
- [Overview](#overview)
- [JSopX™ SaaS Project Dependencies](#visual-studio-jsopx-project-dependencies)
...
Almost all JSopX™ SaaS Projects _require_ `Visual Studio` or `Visual Studio Code` v **`17.14.21`**, to develop and run JSopX™ projects. Installing this version ensures compatibility with the latest .NET Core frameworks and modern web development tools. 
...
[`Visual Studio`]: /JSopX.BridgeTooFar/docs/md/jsopx.Global/Technologies/VisualStudio.md "JSopX™ SaaS Project Visual Studio Technology Requirements"
...
<!--Root Solution Next -->
[`Next »`]: /JSopX.BridgeTooFar/docs/md/jsopx.Global/Technologies/NetFrameworkSdk.md "JSopX™ SaaS Project Solution .NET Framework Techologies"
