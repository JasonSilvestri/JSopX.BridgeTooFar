# .NET Core MAUI Hybrid and Web

**Generated by the JSopX™ SaaS Document Management project, codenamed, `JSopX.BridgeTooFar`.**

**`.NET Core MAUI Hybrid and Web` v `9.2.1` is `Required`**

---

[`Home`] » [`JSopX.BridgeTooFar`] » [`Solutions`] ·· [`VS Templates`] ·· [`Technologies`] » **[`.Net Core Maui Hybrid and Web`]** 
...
- [JSopX™ SaaS Project Dependencies](#net-core-maui-hybrid-jsopx-project-dependencies)

---

## **Overview**  

For cross-platform applications within the JSopX™ ecosystem, the JSopX™ SaaS Projects _require_ `.NET Core MAUI Hybrid and Web` v **`9.2.1`** (_or higher_). This framework allows you to build native apps for Android, iOS, macOS, and Windows with a single codebase. Ensure you have this version or newer installed to develop and run JSopX™ mobile and desktop applications.

Ensure you have this version or newer installed to develop and run JSopX™ mobile and desktop applications.

This section is dedicated to helping you ensure you have the correct `.NET Core MAUI Hybrid and Web` setup, by describing how to check versions, perform installations if necessary, check JSopX™ dependencies, get links to official documentation, and more!
...
## .NET Core MAUI Hybrid and Web: Checking Versions

Check if `.NET Core MAUI Hybrid and Web` v **`9.2.1`** (_or higher_) is installed on your device.

### Step-by-Step Instructions:

Use **`Powershell`** Command Line dialog to ensure you have the correct version of `.NET Core MAUI Hybrid and Web` v `9.2.1` (_or higher_) on your device.
...
These commands check the `version` of `.NET Core MAUI Hybrid and Web` on your device, and then prints back your version to the `Powershell` Command Line dialog output.
   
If you have version `.NET Core MAUI Hybrid and Web` v **`9.2.1`** (_or higher_), you are _good to go_, and no further action is needed!
   
If you do not have .NET Core MAUI Hybrid and Web installed or you version is **`lower`** than `.NET Core MAUI Hybrid and Web` v **`9.2.1`**, it is recommended that you install it _immediately_ to avoid unexpected results.
...
## .NET Core MAUI Hybrid and Web: Installation:

Install `.NET Core MAUI Hybrid and Web` v **`9.2.1`** (_or higher_) if it is not already installed or found on your device.

### Step-by-Step Instructions:

You can use **`Powershell`** Command Line dialog again to `install` the correct version of `.NET Core MAUI Hybrid and Web` v `9.2.1` (_or higher_) on your device.
...
3. This command should _install_ all necessary `.NET Core MAUI Hybrid and Web` dependencies and features, and then prints the results of the installation to the `Powershell` Command Line dialog output.

[`⇧ Back to Top`](#table-of-contents)

---

## .NET Core MAUI Hybrid and Web: Official Downloads & Documentation

> [!WARNING]
> Clicking links in this section will send you to the official `Microsoft` vendor site for `.NET Core MAUI Hybrid and Web`.
> 

---

Visit the official `Microsoft` vendor site for **`.NET Core MAUI Hybrid and Web`** if:

1. You are having trouble with installs
2. You would rather manually install **`.NET Core MAUI Hybrid and Web`** v **`9.2.1`**
3. You prefer some official vendor documentation first
   
#### Step-by-Step Instructions:
   
1. Download: [Manual .NET Core MAUI Hybrid and Web Installation](https://dotnet.microsoft.com/apps/maui)
2. Read: [.NET Core MAUI Hybrid and Web Documentation](https://learn.microsoft.com/en-us/dotnet/maui/)

---

## **.NET Core MAUI Hybrid and Web: `JSopX` Project Dependencies**
...
[`.Net Core Maui Hybrid and Web`]: /JSopX.BridgeTooFar/docs/md/jsopx.Global/Technologies/NetCoreMauiHybrid.md "JSopX™ SaaS Project .NET MAUI Blazor Hybrid and Web Technology Requirements"

<!--Root Solution Previous -->
[`« Previous`]: /JSopX.BridgeTooFar/docs/md/jsopx.Global/Technologies/NetCoreBlazor.md "JSopX™ SaaS Project Solution ASP.NET Core Techologies"
<!--Root Solution Next -->
[`Next »`]: /JSopX.BridgeTooFar/docs/md/jsopx.Global/Technologies/AngularCli.md "JSopX™ SaaS Project Solution ASP.NET Core and Angular and Web Techologies"
