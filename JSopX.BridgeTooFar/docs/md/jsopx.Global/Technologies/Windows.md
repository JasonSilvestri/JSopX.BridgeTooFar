...
**Purpose:** A first-party PLM (Product Lifecycle Management) system for ICSI that starts small (Products → Lifecycles → Lifecycle Phases → Workflows → Decision Gates) but is **device-ubiquitous** (MAUI + Web).
