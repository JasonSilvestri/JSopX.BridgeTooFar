...
[`Home`] » [`JSopX.BridgeTooFar`] » [`Solutions`] ·· [`VS Templates`] ·· [`Technologies`] » **[`ASP.NET Core`]** 
...
- [JSopX™ SaaS Project Dependencies](#aspnet-core-jsopx-project-dependencies)

---

## **Overview**  

Almost all JSopX™ SaaS Projects _require_ `ASP.NET Core` v **`9.2.1`** (_or higher_), and is required to `build`, `run`, and `deploy` the server-side components of JSopX™ projects. 
...
[`ASP.NET Core`]: /JSopX.BridgeTooFar/docs/md/jsopx.Global/Technologies/AspNetCore.md "JSopX™ SaaS Project ASP.NET Core Technology Requirements"

<!--Root Solution Previous -->
[`« Previous`]: /JSopX.BridgeTooFar/docs/md/jsopx.Global/Technologies/NetFrameworkSdk.md "JSopX™ SaaS Project Solution .NET Framework Techologies"
<!--Root Solution Next -->
[`Next »`]: /JSopX.BridgeTooFar/docs/md/jsopx.Global/Technologies/NetCoreBlazor.md "JSopX™ SaaS Project Solution Blazor Core Techologies"
