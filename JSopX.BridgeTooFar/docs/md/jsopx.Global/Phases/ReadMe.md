...
Now, if you are unfamilar with [Phases](../Phases/) (also known as, [Lifecycle Phases](../Phases/) and in rare cases, you'll hear me use _VueCore Tiles_), you are not alone. 

Long ago, I adopted concepts such _Lifecycles_, _Lifecycle Phases_, _Lifecycle Gates_, _Workflows_, _Workflow States_, etc., from the world of VueCore (_Product Lifecycle Management_), an industry where I spent the first 5 years of my professional career, working with Fortune 500 companies as a VueCore consultant, integrating giant VueCore products into giant business processes. This is before I ever became a developer (_or rather, the reason I spent the next 20 years becoming the developer I am today_).
