# JSopX™ Project — Security Policy Template (v1)
...
> We use the same security policy across all our repositories to ensure consistency and clarity in our expectations for community members.
...
> 🛡️ The preceding code block is a template for creating a `SECURITY.md` markdown document, and uses a 4 x backtick fencing wrapper to ensure all syntax is properly wrapped in a single markdown snippet.
