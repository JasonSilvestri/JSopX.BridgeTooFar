...
[`Home`](../jsopx.RCLxProper/p1/v1/README.md) » [`Introduction`](../jsopx.Global/Introduction/) » [`Projects`](../jsopx.RCLxProper/p1/v1/OpenProjects/) · · [`Use Latest`](../jsopx.RCLxProper/README.md) · [`By-Phase`](../jsopx.RCLxProper/p1/v1/README.md) · **`From Scratch`** · · [`« Previous`](../jsopx.RCLxAssets/p1/v1/RECREATEME.md) [`Next »`](../jsopx.RCLxComponents/p1/v1/RECREATEME.md)
...
- **[Install Using Latest](../jsopx.RCLxProper/README.md)** → **Install** or **explore** the latest version of **this project**, using the `JSopX.RCLxProper` _Using Latest_ Variant.  
...
**Goal**: Modern successor to `JSopX.RCLxProper` with static assets for newer frameworks.
...
1. **[Continue](../jsopx.RCLxComponents/p1/v1/RECREATEME.md)** → **Continue** as **you were**, **creating projects** from scratch, step-by-step. You'll move onto the next project, using the `JSopX.RCLxComponents` _From Scratch_ Variant.   

---

1. **[Install Using Latest](../jsopx.RCLxProper/README.md)** → **Install** or **explore** the latest version of **this project**, using the `JSopX.RCLxProper` _Using Latest_ Variant.  
2. **[Browse By-Phase](../jsopx.RCLxProper/p1/v1/README.md)** → **Browse** **previous versions** of the application by **phases** using the `JSopX.RCLxProper` _By-Phase_ Variant.   
...
[`Home`](../jsopx.RCLxProper/p1/v1/README.md) » [`Introduction`](../jsopx.Global/Introduction/) » [`Projects`](../jsopx.RCLxProper/p1/v1/OpenProjects/) · · [`Use Latest`](../jsopx.RCLxProper/README.md) · [`By-Phase`](../jsopx.RCLxProper/p1/v1/README.md) · **`From Scratch`** · · [`⇧ Back to Top`](#table-of-contents) · [`« Previous`](../jsopx.RCLxAssets/p1/v1/RECREATEME.md) [`Next »`](../jsopx.RCLxComponents/p1/v1/RECREATEME.md)
