...
[`Home`](../jsopx.RCLxProper/README.md) » [`Introduction`](../jsopx.Global/Introduction/) » [`Projects`](../../OpenProjects/) · · **`Use Latest`** · [`By-Phase`](../jsopx.RCLxProper/p1/v1/README.md) · [`From Scratch`](../jsopx.RCLxProper/p1/v1/RECREATEME.md) · · [`« Previous`](../jsopx.RCLxAssets/) [`Next »`](../jsopx.RCLxComponents/)
...
- [Visual Studio (v 17.14.21)](../jsopx.RCLxProper/p1/v1/Technologies/#visual-studio)
- [.NET Framework (v 9.2.1)](../jsopx.RCLxProper/p1/v1/Technologies/#net-framework)
- [ASP.NET Core (v 9.2.1)](../jsopx.RCLxProper/p1/v1/Technologies/#aspnet-core)
...
- **[Browse By-Phase](../jsopx.RCLxProper/p1/v1/README.md)** → **Browse** **previous versions** of the application by **phases** using the `JSopX.RCLxProper` _By-Phase_ Variant.   
- **[Start From Scratch](../jsopx.RCLxProper/p1/v1/RECREATEME.md)** → **Create project** from scratch, step-by-step, using the `JSopX.RCLxProper` _From Scratch_ Variant.
...
1. Launch **[Visual Studio (v 17.14.21)](../jsopx.RCLxProper/p1/v1/Technologies/#visual-studio)**.
...
> [!TIP]
>
> Latest versions of [Visual Studio](../jsopx.RCLxProper/p1/v1/Technologies/#visual-studio) performs this step regularly, dropping and restoring project dependencies, nuget packages and other resources between builds automatically (*by design*). Still, it is good practice to at least be aware of the commands outlined in this step.
> 
...
1. Build the solution in [Visual Studio](../jsopx.RCLxProper/p1/v1/Technologies/#visual-studio).
2. Run the project:
...
1. I create a [Visual Studio](../jsopx.RCLxProper/p1/v1/Technologies/#visual-studio) Solution Folder to house the primary `.sln` solution file.
...
1. **Reference the JSopX™ RCL x Proper Project**:
   - Add a reference to `JSopX.RCLxProper` in [`JSopX.BlazorServerCore`](../jsopx.BlazorServerCore/p1/v1).
...
1. **[Continue](../jsopx.RCLxComponents/README.md)** → _Continue_ as **you were**, exploring and/or installing other projects like you did with **this project**. You'll move onto the next project, using the `JSopX.RCLxComponents` _Using Latest_ Variant.  

---

1. **[Browse By-Phase](../jsopx.RCLxProper/p1/v1/README.md)** → **Browse** **previous versions** of the application by **phases** using the `JSopX.RCLxProper` _By-Phase_ Variant.   
2. **[Start From Scratch](../jsopx.RCLxProper/p1/v1/RECREATEME.md)** → **Create project** from scratch, step-by-step, using the `JSopX.RCLxProper` _From Scratch_ Variant.
...
[`Home`](../jsopx.RCLxProper/README.md) » [`Introduction`](../jsopx.Global/Introduction/) » [`Projects`](../../OpenProjects/) · · **`Use Latest`** · [`By-Phase`](../jsopx.RCLxProper/p1/v1/README.md) · [`From Scratch`](../jsopx.RCLxProper/p1/v1/RECREATEME.md) · · [`⇧ Back to Top`](#table-of-contents) · [`« Previous`](../jsopx.RCLxAssets/) [`Next »`](../jsopx.RCLxComponents/)
