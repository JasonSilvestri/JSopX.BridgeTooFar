...
[`Home`](../../OpenProjects/jsopx.ReactCore/README.md) » [`Introduction`](../jsopx.Global/Introduction/) » [`Projects`](../../OpenProjects/) · · **`Use Latest`** · [`By-Phase`](../../OpenProjects/jsopx.ReactCore/p1/v1/README.md) · [`From Scratch`](../../OpenProjects/jsopx.ReactCore/p1/v1/RECREATEME.md) · · [`« Previous`](../../OpenProjects/jsopx.AngularCore/) [`Next »`](../../OpenProjects/jsopx.VueCore/)
...
- **[Continue](../../OpenProjects/jsopx.VueCore/README.md)** → _Continue_ as **you were**, exploring and/or installing other projects like you did with **this project**. You'll move onto the next project, using the `JSopX.VueCore` _Using Latest_ Variant.  
