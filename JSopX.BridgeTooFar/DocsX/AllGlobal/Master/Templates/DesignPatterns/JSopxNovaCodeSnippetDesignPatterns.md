...
| **Blazor**     | `csharp`          | ```` ```csharp ````   | [Blazor Code Example](#blazor-code-example)         |
| **.NET MAUI**  | `csharp`          | ```` ```csharp ````   | [MAUI Code Example](#net-maui-code-example)             |
...
| **XAML**      | `xaml`            | ```` ```xml  ````     | [.NET MAUI XAML Code Example](#net-maui-xaml-example)               |
