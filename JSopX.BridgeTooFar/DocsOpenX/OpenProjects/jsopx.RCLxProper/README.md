...
[`Home`](../../OpenProjects/jsopx.RCLxProper/README.md) » [`Introduction`](../jsopx.Global/Introduction/) » [`Projects`](../../OpenProjects/) · · **`Use Latest`** · [`By-Phase`](../../OpenProjects/jsopx.RCLxProper/p1/v1/README.md) · [`From Scratch`](../../OpenProjects/jsopx.RCLxProper/p1/v1/RECREATEME.md) · · [`« Previous`](../../OpenProjects/jsopx.RCLxAssets/) [`Next »`](../../OpenProjects/jsopx.RCLxComponents/)
...
- [Visual Studio (v 17.14.21)](../../OpenProjects/jsopx.RCLxProper/p1/v1/Technologies/#visual-studio)
- [.NET Framework (v 9.2.1)](../../OpenProjects/jsopx.RCLxProper/p1/v1/Technologies/#net-framework)
- [ASP.NET Core (v 9.2.1)](../../OpenProjects/jsopx.RCLxProper/p1/v1/Technologies/#aspnet-core)
...
1. Launch **[Visual Studio (v 17.14.21)](../../OpenProjects/jsopx.RCLxProper/p1/v1/Technologies/#visual-studio)**.
...
1. **[Continue](../../OpenProjects/jsopx.RCLxComponents/README.md)** → _Continue_ as **you were**, exploring and/or installing other projects like you did with **this project**. You'll move onto the next project, using the `JSopX.RCLxComponents` _Using Latest_ Variant.  
...
[`Home`](../../OpenProjects/jsopx.RCLxProper/README.md) » [`Introduction`](../jsopx.Global/Introduction/) » [`Projects`](../../OpenProjects/) · · **`Use Latest`** · [`By-Phase`](../../OpenProjects/jsopx.RCLxProper/p1/v1/README.md) · [`From Scratch`](../../OpenProjects/jsopx.RCLxProper/p1/v1/RECREATEME.md) · · [`⇧ Back to Top`](#table-of-contents) · [`« Previous`](../../OpenProjects/jsopx.RCLxAssets/) [`Next »`](../../OpenProjects/jsopx.RCLxComponents/)
