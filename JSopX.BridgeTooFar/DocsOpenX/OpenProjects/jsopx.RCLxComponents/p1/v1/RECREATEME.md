...
> [!CAUTION]
> You are currently viewing the **"_Start From Scratch_" _Variant_** of the **JSopX™ RCL x Components Project**. 
> 
...
[`Home`](../../../../OpenProjects/jsopx.RCLxComponents/p1/v1/README.md) » [`Introduction`](../../../jsopx.Global/Introduction/) » [`Projects`](../../../../OpenProjects/jsopx.RCLxComponents/p1/v1/OpenProjects/) · · [`Use Latest`](../../../../OpenProjects/jsopx.RCLxComponents/) · [`By-Phase`](../../../../OpenProjects/jsopx.RCLxComponents/p1/v1/README.md) · **`From Scratch`** · · [`« Previous`](../../../../OpenProjects/RCLxProper/p1/v1/RECREATEME.md) [`Next »`](../../../../OpenProjects/jsopx.AspNetCore/p1/v1/RECREATEME.md)
...
- [Visual Studio (v 17.14.21)](../../../../OpenProjects/jsopx.RCLxComponents/p1/v1/Technologies/VisualStudio.md)
- [.NET Framework (v 9.2.1)](../../../../OpenProjects/jsopx.RCLxComponents/p1/v1/Technologies/NetFrameworkSdk.md)
- [ASP.NET Core (v 9.2.1)](../../../../OpenProjects/jsopx.RCLxComponents/p1/v1/Technologies/AspNetCore.md)
...
### 1. **Continue Creating `JSopX.`RCLxComponents From Scratch**:

- **[Continue](#step-1-recreate-using-aspnet-core-razor-class-library-template)** → **Continue** as **you were**, **creating projects** from scratch, step-by-step, using the `JSopX.RCLxComponents` _From Scratch_ Variant.   
...
- **[Browse By-Phase](../../../../OpenProjects/jsopx.RCLxComponents/p1/v1/README.md)** → **Browse** **previous versions** of the application by **phases** using the `JSopX.RCLxComponents` _By-Phase_ Variant.   
...
2. **Create the Project**:
   ...
   - Configure:
     - Project Name: `JSopX.RCLxComponents`.
     - Location: e.g., `path\to\local\repo\JasonSilvestri\JSopX.RCLxComponents`.
     - Solution Name: `JSopX.RCLxComponents`.
     - .NET Framework (v 9.2.1)
   - Click Create.

3. **Set Up Initial Assets**:
   - Add `wwwroot/css/bootstrap.css`: Copy from Bootstrap 5.3.3.
   - Add `wwwroot/js/weatherUtils.js`: Copy from `JSopX.RCLxComponents`.
...
**Goal**: Transition from `JSopX.RCLxComponents`.

1. **Reference in Projects**:
   - In `JSopX.MauiHybridNetCore`’s `Home.razor`:

     ```razor
     <link href="_content/JSopX.RCLxComponents/css/bootstrap.css" rel="stylesheet" />
     <WeatherTable><tr><td>...</td></tr></WeatherTable>
     ```
   - In `JSopX.AngularCore`’s `angular.json`:

     ```json
     "styles": ["../JSopX.RCLxComponents/wwwroot/css/bootstrap.css"]
     ```
...
1. **[Continue](../../../../OpenProjects/jsopx.AspNetCore/p1/v1/RECREATEME.md)** → **Continue** as **you were**, **creating projects** from scratch, step-by-step. You'll move onto the next project, using the `JSopX.AspNetCore` _From Scratch_ Variant.   

---

1. **[Install Using Latest](../../../../OpenProjects/jsopx.RCLxComponents/README.md)** → **Install** or **explore** the latest version of **this project**, using the `JSopX.RCLxComponents` _Using Latest_ Variant.  
2. **[Browse By-Phase](../../../../OpenProjects/jsopx.RCLxComponents/p1/v1/README.md)** → **Browse** **previous versions** of the application by **phases** using the `JSopX.RCLxComponents` _By-Phase_ Variant.   
3. **[Get All Projects](../../../../OpenProjects/jsopx.OpenProjectX/README.md)** → **Get all projects** instead, using the `JSopX.OpenProjectX` Enterprise Application.

---

[`Home`](../../../../OpenProjects/jsopx.RCLxComponents/p1/v1/README.md) » [`Introduction`](../../../jsopx.Global/Introduction/) » [`Projects`](../../../../OpenProjects/jsopx.RCLxComponents/p1/v1/OpenProjects/) · · [`Use Latest`](../../../../OpenProjects/jsopx.RCLxComponents/README.md) · [`By-Phase`](../../../../OpenProjects/jsopx.RCLxComponents/p1/v1/README.md) · **`From Scratch`** · · [`⇧ Back to Top`](#table-of-contents) · [`« Previous`](../../../../OpenProjects/RCLxProper/p1/v1/RECREATEME.md) [`Next »`](../../../../OpenProjects/jsopx.AspNetCore/p1/v1/RECREATEME.md)
