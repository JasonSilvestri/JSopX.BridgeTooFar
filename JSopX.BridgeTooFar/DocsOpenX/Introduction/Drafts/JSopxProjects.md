...
[`Introduction`](./ReadMe.md) » **`JSopX™ Visual Studio Projects`**  · · · [`« Previous`](./JasonSilvestriOpenProjectExperiences.md) [`Next »`](./JSopxProjectsFamilies.md)
...
- Review the overarching JSopX™ context provided in the [Introduction](./Introduction/) and [Jason Silvestri’s Open Project Experiences (JSopX™)](./JasonSilvestriOpenProjectExperiences.md) documents.
...
- Keep the [Introduction](./Introduction/), [Alerts](./Alerts.md), and [Jason Silvestri’s Open Project EXperiences (JSopX™)](./JasonSilvestriOpenProjectExperiences.md) handy. They provide context and clarify design decisions.
...
[JSopX™ Angular Core GitHub](https://github.com/JasonSilvestri/JSopX.AngularCore)
...
[`Introduction`](./ReadMe.md) » **`JSopX™ Visual Studio Projects`**  · · · [`Back to Top`](#table-of-contents) · · · [`« Previous`](./JasonSilvestriOpenProjectExperiences.md) [`Next »`](./JSopxProjectsFamilies.md)
...
- Reference the [Alerts](./Alerts.md) or [Introduction](./Introduction/) documents when clarity or guidance is needed.
