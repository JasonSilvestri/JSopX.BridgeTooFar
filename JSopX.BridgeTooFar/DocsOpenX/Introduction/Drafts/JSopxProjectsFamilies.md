...
[`Introduction`](./ReadMe.md) » **`JSopX™ Project Families`**  · · · [`« Previous`](./JSopxProjects.md) [`Next »`](./JSopxProjectChecksBalances.md)
...
- Review the [Introduction](./Introduction/) and the overarching goals of JSopX™ to understand why such categorization is vital.
...
[`Introduction`](./ReadMe.md) » `JSopX™ Project Families` » [`Back to Top`](#table-of-contents) · · · [`« Previous`](./JSopxProjects.md) [`Next »`](./JSopxProjectChecksBalances.md)
