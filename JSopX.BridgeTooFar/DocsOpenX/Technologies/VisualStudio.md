...
**`Visual Studio` or `Visual Studio Code` v `17.14.11` is `Required`**
...
Almost all JSopX™ Open Project EXperiences _require_ `Visual Studio` or `Visual Studio Code` v **`17.14.11`**, to develop and run JSopX™ projects. Installing this version ensures compatibility with the latest .NET Core frameworks and modern web development tools. 
...
Check if `Visual Studio` v **`17.14.11`** (_or higher_) is installed on your device.

### Step-by-Step Instructions: Using Powershell

Use **`Powershell`** Command Line dialog to ensure you have the correct version of `Visual Studio` v `17.14.11` (_or higher_) on your device.
...
3. **Expected Output:** 
 ...
 If you have version `Visual Studio` v **`17.14.11`** (_or higher_), you are _good to go_, and no further action is needed!
   
 If you do not have Visual Studio installed or you version is **`lower`** than `Visual Studio` v **`17.14.11`**, it is recommended that you install it _immediately_ to avoid unexpected results.
...
Install `Visual Studio` v **`17.14.11`** (_or higher_) if it is not already installed or found on your device.

#### Step-by-Step Instructions:

You can use **`Powershell`** Command Line dialog again to _install_ the correct version of `Visual Studio` or `Visual Studio Code` v `17.14.11` on your device.
...
2. You would rather manually install **`Visual Studio`** or **`Visual Studio Code`** v **`17.14.11`**
