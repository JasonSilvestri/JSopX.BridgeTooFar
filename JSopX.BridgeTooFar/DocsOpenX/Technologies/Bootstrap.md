...
- [Overview](#overview)
- [JSopX™ Project Dependencies](#bootstrap-jsopx-project-dependencies)
- [Check Versions](#bootstrap-checking-versions)
- [Installation](#bootstrap-installation)
- [Downloads & Documentation](#bootstrap-official-downloads--documentation)

---

## **Overview**  

All JSopX™ Open Project EXperiences _can use_ `Bootstrap` v **`5.3+`** (_or higher_), for command-line operations, such as cloning JSopX™ project repositories, initializing JSopX™ projects, and managing their dependencies. 

This section is dedicated to helping you ensure you have the correct `Bootstrap` setup, by describing how to check versions, perform installations if necessary, check JSopX™ dependencies, get links to official documentation, and more!

[`⇧ Back to Top`](#table-of-contents)

---

## Bootstrap: Checking Versions

Check if `Bootstrap` v **`5.3+`** (_or higher_) is installed on your device.

### Step-by-Step Instructions:

Use **`Node`** Command Line dialog to ensure you have the correct version of `Bootstrap` v `5.3+` (_or higher_) on your device.
...
3. **Expected Output:** 
     ```
      GNU Bootstrap, version 5.x
     ```
4. **Purpose:** Checks the currently active Bootstrap version.

These commands check the `version` of `Bootstrap` on your device, and then prints back your version to the `Node` Command Prompt output.
   
If you have version `Bootstrap` v **`5.3+`** (_or higher_), you are _good to go_, and no further action is needed!
   
If you do not have Bootstrap installed or you version is **`lower`** than `Bootstrap` v **`5.3+`**, it is recommended that you install it _immediately_ to avoid unexpected results.
...
Install `Bootstrap` v **`5.3+`** (_or higher_) if it is not already installed or found on your device.

### Step-by-Step Instructions:

You can use **`Node`** Command Line dialog again to `install` the correct version of `Bootstrap` v `5.3+` (_or higher_) on your device.
...
3. This command should _install_ all necessary `Bootstrap` dependencies and features, and then prints the results of the installation to the `Node` Command Line dialog output.

[`⇧ Back to Top`](#table-of-contents)

---

## **Bootstrap: `JSopX.` Project Dependencies**
...
## Bootstrap: Official Downloads & Documentation

> [!WARNING]
> Clicking links in this section will send you to the official `Bootstrap` vendor site for `Bootstrap 5.3.8+`.
> 

---

Visit the official `Bootstrap` vendor site for **`Bootstrap`** if:

1. You are having trouble with installs
2. You would rather manually install **`Bootstrap`** v **`5.3+`**
3. You prefer some official vendor documentation first
   
#### Step-by-Step Instructions:
   
1. Download: [Manual Bootstrap Installation](https://getbootstrap.com/)
2. Read: [Bootstrap Documentation](https://getbootstrap.com/docs/5.3/getting-started/introduction/)

---

[`Home`](https://github.com/JasonSilvestri/JSopX.BridgeTooFar/tree/master/JSopX.BridgeTooFar/DocsOpenX/OpenProjects/jsopx.BridgeTooFar/README.md) » [`Introduction`](https://github.com/JasonSilvestri/JSopX.BridgeTooFar/tree/master/JSopX.BridgeTooFar/DocsOpenX/Introduction/) »  [`Technologies`](./ReadMe.md) » **[`Bootstrap`](./Bootstrap.md)** · · · [`⇧ Back to Top`](#table-of-contents) · · · [`« Previous`](./Vite.md) [`Next »`](./Powershell.md)
