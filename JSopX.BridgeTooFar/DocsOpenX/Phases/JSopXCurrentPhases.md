...
> **This will be Phases:**
> 
> Jay, we will use this format for phases. I passed by `Project Families` 5-6 this week, like, "I want to use this format and simplicity". Moreover, this will end up becoming the official `Phases.md` Navigation pages.
>
